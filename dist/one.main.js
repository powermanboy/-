...
/* harmony import */ var _two__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./two */ "./src/two.js");
...
var _marked = /*#__PURE__*/_babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(helloWorldGenerator);



var x = 100;
console.log("x", x);
console.log("y", _two__WEBPACK_IMPORTED_MODULE_3__["default"].y); //箭头函数ES6

var test = function test(num) {
  return num + 100;
};

console.log(test(_two__WEBPACK_IMPORTED_MODULE_3__["default"].y));
...
var MyTestableClass = testable(_class = function MyTestableClass() {
  _babel_runtime_corejs2_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, MyTestableClass);
}) || _class;
...
var delay = new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_2___default.a(function (resolve) {
  return console.log("new Promise()");
});

function helloWorldGenerator() {
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function helloWorldGenerator$(_context) {
    while (1) {
